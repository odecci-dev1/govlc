...
class CreateApplication extends Component
{
    ...
    {       
        ...
        if($this->type == 3){
            ...
            $this->comaker['co_BO_Status'] = $data['co_BO_Status']; 
            ...
            if($this->memId != ''){
                $value = Http::withToken(getenv('APP_API_TOKEN'))->post(getenv('APP_API_URL').'/api/Member/PostMemberSearching', ['type' => 'MemId', 'values' => $this->memId]);  
                $resdata = $value->json();          
                $data =  $resdata[0];
            ...
            // $this->member['lname'] = 'Cave';
            // $this->member['mname'] = 'Badajos';
            // $this->member['suffix'] = ''; 
            // $this->member['age'] = '20'; 
