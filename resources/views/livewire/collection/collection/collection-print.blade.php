            ...
            @if($areaDetails)
                ...
                @foreach($areaDetails as $mdetails)
                    ...
                    <div class="header-wrapper">
                        ...
                        <p>Collection List Number <span id="printCollectionListNumber">{{ $areaDetails[0]['area_RefNo'] }}</span></p>
                    </div>
                    ...
                    @endif
                        <div class="box">
                            ...
                            <p>Advance / Lapses: <span id="printAdvanceOrLapses">{{ $mdetails['advancePayment'] > 0 ? number_format($mdetails['advancePayment'], 2) : number_format($mdetails['lapsePayment'], 2) }}</span></p>
                        </div>
