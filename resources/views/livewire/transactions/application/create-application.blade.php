            ...
            <div class="na-notes-remarks-sec">
                <div class="wrapper-1">
                    ...
                    <div class="btn-wrapper">
                        ...
                        <button type="button" wire:click="submitForApproval" class="button"
                            data-submit-for-approval>Submit for approval</button>
                        <!-- </a> -->
            ...
            <div class="na-releasing-sec">
                            ...
                            <div class="select-box">
                                ...
                                <div class="options-container" data-option-con10>
                                    ...
                                    <div class="option" data-option-item10>
                                        ...
                                        <input type="radio" wire:model.lazy="loanDetails.modeOfRelease" class="radio"
                                            id="modeOfRelease1" name="modeOfRelease" value="Cash" />
                                    ...
                                    <div class="option" data-option-item10>
                                        ...
                                        <input type="radio" wire:model.lazy="loanDetails.modeOfRelease" class="radio"
                                            id="modeOfRelease2" name="modeOfRelease" value="Check" />
                        ...
                        @if (isset($loanDetails['modeOfRelease']))
                            @if ($loanDetails['modeOfRelease'] == 'Cash')
                                <div class="input-wrapper" data-toggle-mor-1>
                                    ...
                                    <input autocomplete="off" wire:model.lazy="loanDetails.denomination" type="text"
                            ...
                            @if ($loanDetails['modeOfRelease'] == 'Check')
                                ...
                                <div class="input-wrapper" data-toggle-mor-2>
                                    ...
                                    <input autocomplete="off" wire:model.lazy="loanDetails.checkNumber" type="text"
                                        id="checkNumber" name="checkNumber">
                                </div>
                            @endif
                        @endif
                ...
                <div class="rowspan">
                    ...
                    @if ($member['statusID'] == 9)
                        <div class="input-wrapper">
                            <p style="font-size:1.5rem;color:darkgoldenrod;">Waiting for Approval...</p>
                            <!-- This will show if same user is  approved this application-->
                            <p style="font-size:1.5rem;color:green;">Approved By: Jumar 25 mins ago</p>
                            <!-- this will show to another approving officer-->
                            <button type="button" wire:click="approveForReleasing" class="button">Approve for
                                Releasing</button>
                        </div>
                    @elseif($member['statusID'] == 10)
                        <!-- * Approve for Releasing Button -->
                        <div class="input-wrapper input-wrapper-release">
                            <button type="button" wire:click="signForRelease" class="releaseButton"
                                data-sign-for-releasing-button>Sign For Releasing</button>
                        </div>
                    @elseif($member['statusID'] == 15)
                        <div class="input-wrapper input-wrapper-release">
                            <button type="button" wire:click="completeApplication" class="releaseButton"
                                data-application-complete-button>Complete</button>
                        </div>
                    @endif
                ...
                <div class="rowspan">
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="select-box"
                            style="{{ in_array($member['statusID'], [10, 15]) ? 'pointer-events: none; color: #808080;' : '' }}">
                                ...
                                @if (isset($termsOfPaymentList))
                                    @foreach ($termsOfPaymentList as $termsOfPaymentList)
                                        <div class="option" data-type-loan-opt data-individual-loan-link>
                                            ...
                                            <input type="radio" wire:model="loanDetails.topId" class="radio"
                                                value="{{ $termsOfPaymentList['topId'] }}"
                                                id="topId{{ $termsOfPaymentList['topId'] }}" name="top" />
                    ...
                    <div class="input-wrapper">
                        ...
                        <input disabled wire:model.lazy="loanDetails.noofnopayment" autocomplete="off"
                            type="number">
                    </div>
                    ...
                    @else
                        <div class="input-wrapper input-wrapper-decline">
                            <button type="button" class="declineButton"
                                data-open-application-decline>Decline</button>
                        </div>
                    @endif
                ...
                <div class="rowspan">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input {{ in_array($member['statusID'], [10, 15]) ? 'disabled' : '' }}
                            wire:model.lazy="loanDetails.approvedBy" autocomplete="off" type="text"
                    ...
                    <div class="input-wrapper">
                        ...
                        <input {{ in_array($member['statusID'], [10, 15]) ? 'disabled' : '' }}
                            wire:model.lazy="loanDetails.notes" autocomplete="off" type="text">
                    </div>
                                ...
                                <div class="box-wrap">
                                    ...
                                    <div class="radio-btn-wrapper">
                                        ...
                                        <input autocomplete="off" type="radio"
                                            wire:model.lazy="loanDetails.courier" name="courier" value="Employee"
                                            id="employee">
                                    </div>
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Client</span>
                                        <input autocomplete="off" type="radio"
                                            wire:model.lazy="loanDetails.courier" name="courier" value="Client"
                                            id="client">
                                    </div>
                            ...
                            @if (isset($loanDetails['courier']))
                                    ...
                                    @if ($loanDetails['courier'] == 'Employee')
                                        ...
                                        <div class="input-wrapper" data-employee-search-toggle>
                                            ...
                                            <div class="primary-search-bar">
                                                <div class="row">
                                                    <input wire:model.lazy="loanDetails.courieremployee"
                                    ...
                                    @if ($loanDetails['courier'] == 'Client')
                                        ...
                                        <div class="input-wrapper" data-client-name-toggle>
                                            <div class="input-wrapper">
                                                ...
                                                <input wire:model.lazy="loanDetails.courierclient" autocomplete="off"
                                                    type="text">
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="input-wrapper" data-contact-number-toggle>
                                    <div class="input-wrapper">
                                        ...
                                        <input wire:model.lazy="loanDetails.couriercno" autocomplete="off"
                                            type="number">
                                    </div>
                                </div>
                            @endif
                ...
                <div class="big-con">
                    ...
                    <div class="rowspan">
                        ...
                        <div class="header-wrapper">
                            ...
                            <button type="button" class="viewLoanDetailsButton" id="data-open-loan-details">View
                                loan & payment history</button>
                        </div>
                        ...
                        <div class="btn-wrapper">
                            ...
                            <!-- * Save -->
                            @if ($type == 'create')
                                <button wire:click="store(1)" type="button" wire:loading.attr="disabled"
                                    class="button" data-save>Save</button>

                                <!-- * Save & Apply for loan  dito -->
                                <a href="#">
                                    <button type="button" wire:click="store(2)" wire:loading.attr="disabled"
                                        class="button" onclick="activeProgressButton()" data-proceed-to-ci>Save &
                                        Proceed to CI</button>
                                </a>
                            @elseif($type == 'view')
                                @if ($member['statusID'] == 7)
                                    <button wire:click="update(1)" type="button" class="button"
                                        data-save>Update</button>
                                    <button wire:click="update(2)" onclick="showAskingDialog()" type="button"
                                        class="button" data-save>Submit And Proceed to CI</button>
                                ...
                                @endif
                            @elseif($type == 'add')
                                <button wire:click="store" type="button" class="button" data-save>Add To
                                    Group</button>
                            @endif
                    ...
                    <div class="rowspan">
                        ...
                        <div class="input-wrapper">
                            ...
                            @error('member.fname')
                                <span class="text-required">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="rowspan">
                            ...
                            <div class="select-box">
                                ...
                                <div class="options-container" data-option-con1>
                                    ...
                                    <div class="option" data-option-item1>
                                        ...
                                        <input type="radio" wire:model.lazy="member.gender" class="radio"
                                            id="Male" value="Male" />
                                        <label for="Male">
                                            <h4>Male</h4>
                                        </label>
                        ...
                        <div class="input-wrapper">
                            ...
                            <input wire:model.lazy="member.dob" wire:change="getmemberAge" autocomplete="off"
                                type="date">
                            @error('member.dob')
                                <span class="text-required">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="input-wrapper">
                            <span>Age</span>
                            <input wire:model.lazy="member.age" disabled="disabled" autocomplete="off"
                                type="number">
                            @error('member.age')
                                <span class="text-required">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="select-box">
                                ...
                                <div class="options-container" data-option-con2>
                                    ...
                                    <div class="option" data-option-item2>
                                        ...
                                        <input wire:model="member.civil_Status" type="radio" class="radio"
                                            id="mem_Widow" value="Widow" />
                                        <label for="mem_Widow">
                                            <h4>Widow</h4>
                                        </label>
                    ...
                    <div class="rowspan">
                        ...
                        <div class="input-wrapper">
                            ...
                            <div class="box-wrap">
                                ...
                                <div class="radio-btn-wrapper">
                                    <span>Rented</span>
                                    <input wire:model.lazy="member.house_Stats" autocomplete="off" type="radio"
                                        value="1" name="house_Stats" id="mem_rented">
                                </div>
                                ...
                                <div class="radio-btn-wrapper">
                                    <span>Owned</span>
                                    <input wire:model.lazy="member.house_Stats" autocomplete="off" type="radio"
                                        value="2" name="house_Stats" id="mem_owned">
                                </div>
                                ...
                                <div class="radio-btn-wrapper">
                                    <span>Free Use</span>
                                    <input wire:model.lazy="member.house_Stats" autocomplete="off" type="radio"
                                        value="3" name="house_Stats" id="mem_freeUse">
                                </div>

                            </div>
                            @error('member.house_Stats')
                                <span class="text-required">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <div class="input-wrapper">
                                @if (isset($member['profile']))
                                    <input type="image" class="profile"
                                        src="{{ $member['profile']->temporaryUrl() }}" alt="upload-image">
                                @else
                                    <input type="image" class="profile"
                                        src="{{ URL::to('/') }}/assets/icons/upload-image.svg" alt="upload-image">
                                @endif
                            </div>
                            @error('member.profile')
                                <span class="error">{{ $message }}</span>
                            @enderror
                            <div class="btn-wrapper">
                                <!-- * Upload Button -->
                                <input type="file" wire:model="member.profile"
                                    class="input-image upload-profile-image-btn"
                                    accept=".jpg, .jpeg, .png, .gif, .svg" data-upload-borrower-image-btn></input>
                                <!-- * Attach Button -->
                                <input type="file" wire:model="member.attachments"
                                    class="input-image attach-file-btn" accept=".txt, .pdf, .docx, .xlsx" multiple
                                    data-attach-file-btn></input>
                            </div>
                                ...
                                @if (isset($member['attachments']))
                                    @foreach ($member['attachments'] as $attachments)
                                        <div type="button" class="fileButton">
                                            ...
                                            <a href="{{ $attachments->path() }}" target="_blank"
                                                alt="file.png">{{ $attachments->getClientOriginalName() }}</a>
                                        </div>
                        ...
                        <div class="select-box">
                            <div class="options-container" data-option-con3>
                                ...
                                <div class="option" data-option-item3>
                                    ...
                                    <input wire:model.lazy="member.emp_Status" type="radio" class="radio"
                                        id="Employed" value="1" />
                                    <label for="Employed">
                                        <h4>Employed</h4>
                                    </label>
                ...
                <div class="rowspan">
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="box-wrap">
                            ...
                            <!-- * Rented -->
                            <div class="radio-btn-wrapper">
                                <input wire:model="member.bO_Status" autocomplete="off" type="radio"
                                    name="mem_bO_Status" value="1">
                                <span>Yes</span>
                            </div>
                            ...
                            <div class="radio-btn-wrapper">
                                <input wire:model="member.bO_Status" autocomplete="off" type="radio"
                                    name="mem_bO_Status" value="0">
                                <span>No</span>
                            </div>

                        </div>
                        @error('member.bO_Status')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                                ...
                                <div class="select-box">
                                    ...
                                    <div class="options-container" data-option-con7>
                                        ...
                                        <div class="option" data-option-item7>
                                            ...
                                            <input wire:model.lazy="member.f_Emp_Status" type="radio"
                                                class="radio" id="f_mem_Employed" value="1" />
                                        ...
                                        <div class="option" data-option-item7>
                                            ...
                                            <input wire:model.lazy="member.f_Emp_Status" type="radio"
                                                class="radio" id="f_mem_Unemployed" value="0" />
                        ...
                        @if (count($cntmemchild) > 0)
                            @foreach ($cntmemchild as $cntchild)
                                <div class="rowspan child" data-child>
                                    ...
                                    <div class="input-wrapper">
                                        <span>First Name</span>
                                        <input wire:model.lazy="inpchild.fname{{ $cntchild }}" autocomplete="off"
                                            type="text">
                                        @error('inpchild.fname' . $cntchild)
                                            <span class="text-required">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-wrapper">
                                        <span>Middle Name</span>
                                        <input wire:model.lazy="inpchild.mname{{ $cntchild }}" autocomplete="off"
                                            type="text">
                                        @error('inpchild.mname' . $cntchild)
                                            <span class="text-required">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-wrapper">
                                        <span>Last Name</span>
                                        <input wire:model.lazy="inpchild.lname{{ $cntchild }}" autocomplete="off"
                                            type="text">
                                        @error('inpchild.lname' . $cntchild)
                                            <span class="text-required">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-wrapper">
                                        <span>Age</span>
                                        <input wire:model.lazy="inpchild.age{{ $cntchild }}" autocomplete="off"
                                            type="number">
                                        @error('inpchild.age' . $cntchild)
                                            <span class="text-required">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        <input wire:model.lazy="inpchild.school{{ $cntchild }}"
                                            autocomplete="off" type="text">
                                        @error('inpchild.school' . $cntchild)
                                            <span class="text-required">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        @else
                                            <button type="button"
                                                wire:click="subChild({{ $cntchild }})">-</button>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
                    ...
                    <div class="small-con-4">
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                ...
                                @error('membusinfo.businessAddress')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="box-wrap">
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Rented</span>
                                        <input wire:model.lazy="membusinfo.b_status" autocomplete="off"
                                            type="radio" name="mem_b_status" value="5">
                                    </div>
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Owned</span>
                                        <input wire:model.lazy="membusinfo.b_status" autocomplete="off"
                                            type="radio" name="mem_b_status" value="6">
                                    </div>

                                </div>
                                @error('membusinfo.b_status')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="box-wrap">
                                    ...
                                    <!-- * Yes -->
                                    <div class="radio-btn-wrapper">
                                        <input wire:model="hasvehicle" name="hasvehicle" autocomplete="off"
                                            type="radio" value="1">
                                        <span>Yes</span>
                                    </div>
                                    ...
                                    @if (count($vehicle) > 0)
                                        @foreach ($vehicle as $key => $value)
                                            <div class="rowspan-2 child"
                                                style="{{ isset($hasvehicle) ? ($hasvehicle == 1 ? '' : 'pointer-events: none; opacity: 0.4;') : 'pointer-events: none; opacity: 0.4;' }}">
                                                <!-- * Vehicle Input Field -->
                                                <div class="input-wrapper">
                                                    <input wire:model.lazy="inpvehicle.vehicle{{ $key }}"
                                                        autocomplete="off" type="text">
                                                    @error('inpvehicle.vehicle' . $key)
                                                        <span class="text-required">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                <!-- * Add and Subtract Button  -->
                                                <div class="input-wrapper">
                                                    ...
                                                    @else
                                                        <button type="button"
                                                            wire:click="subVehicle({{ $key }})">-</button>
                                                    @endif
                                                </div>
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="box-wrap">
                                    ...
                                    <!-- * Yes -->
                                    <div class="radio-btn-wrapper">
                                        <input wire:model="hasproperties" autocomplete="off" type="radio"
                                            name="hasproperties" value="1">
                                        <span>Yes</span>
                                    </div>
                                ...
                                <div class="input-wrapper" data-property>
                                    ...
                                    @if (count($properties) > 0)
                                        @foreach ($properties as $key => $value)
                                            <div class="rowspan-2 child"
                                                style="{{ isset($hasproperties) ? ($hasproperties == 1 ? '' : 'pointer-events: none; opacity: 0.4;') : 'pointer-events: none; opacity: 0.4;' }}">
                                                <!-- * Vehicle Input Field -->
                                                <div class="input-wrapper">
                                                    <input wire:model="inpproperties.property{{ $key }}"
                                                        autocomplete="off" type="text">
                                                    @error('inpproperties.property' . $key)
                                                        <span class="text-required">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="input-wrapper">
                                                    ...
                                                    @else
                                                        <button type="button"
                                                            wire:click="subProperty({{ $key }})">-</button>
                                                    @endif
                                                </div>
                                ...
                                @foreach ($appliances as $key => $value)
                                    <div class="rowspan child" data-appliances>
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input wire:model="inpappliances.applaince{{ $key }}"
                                                autocomplete="off" type="text">
                                            @error('inpappliances.applaince' . $key)
                                                <span class="text-required">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input wire:model="inpappliances.brand{{ $key }}"
                                                autocomplete="off" type="text">
                                            @error('inpappliances.brand' . $key)
                                                <span class="text-required">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            @else
                                                <button type="button"
                                                    wire:click="subAppliances({{ $key }})">-</button>
                                            @endif
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                @foreach ($bank as $key => $value)
                                    <div class="rowspan child" data-bank>
                                        ...
                                        <div class="input-wrapper">
                                            ...
                                            <input wire:model="inpbank.account{{ $key }}"
                                                autocomplete="off" type="bankAcc">
                                            @error('inpbank.account' . $key)
                                                <span class="text-required">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="input-wrapper">
                                            <span>Address</span>
                                            <input wire:model="inpbank.address{{ $key }}"
                                                autocomplete="off" type="bankAddr">
                                            @error('inpbank.address' . $key)
                                                <span class="text-required">{{ $message }}</span>
                                            @enderror
                                        </div>
                ...
                <div class="container-wrapper">
                    ...
                    <div class="big-con">
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                <span>First Name</span>
                                <input wire:model.lazy="comaker.co_Fname" autocomplete="off" type="text"
                                    id="fName" name="fName">
                                @error('comaker.co_Fname')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-wrapper">
                                <span>Middle Name</span>
                                <input wire:model.lazy="comaker.co_Mname" autocomplete="off" type="text"
                                    id="midName" name="midName">
                                @error('comaker.co_Mname')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-wrapper">
                                <span>Last Name</span>
                                <input wire:model.lazy="comaker.co_Lname" autocomplete="off" type="text"
                                    id="lName" name="lName">
                                @error('comaker.co_Lname')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-wrapper">
                                <span>Suffix</span>
                                <input wire:model.lazy="comaker.co_Suffix" autocomplete="off" type="text"
                                    id="suffix" name="suffix">
                                @error('comaker.co_Suffix')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="rowspan">
                                ...
                                <div class="select-box">
                                    ...
                                    <div class="options-container" data-option-con4>
                                        ...
                                        <div class="option" data-option-item4>
                                            ...
                                            <input type="radio" wire:model="comaker.co_Gender"
                                                id="comakerGendermale" class="radio" value="Male" />
                                        ...
                                        <div class="option" data-option-item4>
                                            ...
                                            <input type="radio" wire:model="comaker.co_Gender"
                                                id="comakerGenderfemale" class="radio" value="Female" />
                            ...
                            <div class="input-wrapper">
                                <span>Age</span>
                                <input wire:model.lazy="comaker.co_Age" autocomplete="off" type="number"
                                    id="age" name="age">
                                @error('comaker.co_Age')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-wrapper">
                                <span>Place Of Birth</span>
                                <input wire:model.lazy="comaker.co_POB" autocomplete="off" type="text"
                                    id="poBirth" name="poBirth">
                                @error('comaker.co_POB')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="select-box">
                                    ...
                                    <div class="options-container" data-option-con5>
                                        ...
                                        <div class="option" data-option-item5>
                                            ...
                                            <input wire:model="comaker.co_Civil_Status" type="radio"
                                                id="comakerWidow" name="co_Civil_Status" class="radio"
                                                value="Widow" />
                                        ...
                                        <div class="option" data-option-item5>
                                            ...
                                            <input wire:model="comaker.co_Civil_Status" type="radio"
                                                id="comakerMarried" name="co_Civil_Status" class="radio"
                                                value="Married" />
                                        ...
                                        <div class="option" data-option-item5>
                                            ...
                                            <input wire:model="comaker.co_Civil_Status" type="radio"
                                                id="comakerSingle" name="co_Civil_Status" class="radio"
                                                value="Single" />
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                <div class="input-wrapper">
                                    <span>Email Address</span>
                                    <input wire:model.lazy="comaker.co_EmailAddress" autocomplete="off"
                                        type="email">
                                    @error('comaker.co_EmailAddress')
                                        <span class="text-required">{{ $message }}</span>
                                    @enderror
                                </div>
                            </div>
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                ...
                                <div class="box-wrap">
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Rented</span>
                                        <input wire:model.lazy="comaker.co_House_Stats" autocomplete="off"
                                            type="radio" name="co_House_Stats" value="1">
                                    </div>
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Owned</span>
                                        <input wire:model.lazy="comaker.co_House_Stats" autocomplete="off"
                                            type="radio" name="co_House_Stats" value="2">
                                    </div>
                                    ...
                                    <div class="radio-btn-wrapper">
                                        <span>Free Use</span>
                                        <input wire:model.lazy="comaker.co_House_Stats" autocomplete="off"
                                            type="radio" name="co_House_Stats" value="3">
                                    </div>

                                </div>
                                @error('comaker.co_House_Stats')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="rowspan">
                            ...
                            <div class="input-wrapper">
                                <span>Zip Code</span>
                                <input wire:model.lazy="comaker.co_ZipCode" type="number" id="zipCode"
                                    name="zipCode">
                                @error('comaker.co_ZipCode')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="input-wrapper">
                                <span>Years of stay on the mentioned address</span>
                                <input wire:model.lazy="comaker.co_YearsStay" type="number" id="yoStay"
                                    name="yoStay">
                                @error('comaker.co_YearsStay')
                                    <span class="text-required">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="colspan">
                                    ...
                                    <div class="input-wrapper" data-upload-image-co-borrower-hover-container>
                                        @if (isset($comaker['profile']))
                                            <input type="image" class="profile"
                                                src="{{ $comaker['profile']->temporaryUrl() }}"
                                                alt="upload-image">
                                        @else
                                            <input type="image" class="profile"
                                    ...
                                    @error('comaker.profile')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                    <div class="btn-wrapper">
                                        <!-- * Upload Button -->
                                        <input type="file" wire:model="comaker.profile"
                                            class="input-image upload-profile-image-btn"
                                            accept=".jpg, .jpeg, .png, .gif, .svg"
                                            data-upload-borrower-image-btn></input>
                                        <!-- * Attach Button -->
                                        <input type="file" wire:model="comaker.attachments"
                                            class="input-image attach-file-btn" accept=".txt, .pdf, .docx, .xlsx"
                                            multiple data-attach-file-btn></input>
                                    </div>
                                    ...
                                    <div class="file-wrapper" data-attach-file-container2>
                                        @if (isset($comaker['attachments']))
                                            @foreach ($comaker['attachments'] as $comakerattachments)
                                                <div type="button" class="fileButton">
                                                    <img src="{{ URL::to('/') }}/assets/icons/file.svg"
                                                        alt="file.png">
                                                    <a href="{{ $comakerattachments->path() }}" target="_blank"
                                                        alt="file.png">{{ $comakerattachments->getClientOriginalName() }}</a>
                                                </div>
        ...
        <div class="na-container-3">
            ...
            <div class="small-con-2">
                ...
                <div class="rowspan">
                        ...
                        <div class="select-box">
                            <div class="options-container" data-option-con6>
                                ...
                                <div class="option" data-option-item6>
                                    <input wire:model.lazy="comaker.co_Emp_Status" type="radio"
                                        id="comakerEmployed" class="radio" value="1" />
                                ...
                                <div class="option" data-option-item6>
                                    <input wire:model.lazy="comaker.co_Emp_Status" type="radio"
                                        id="comakerUnemployed" class="radio" value="0" />
                    ...
                    <div class="input-wrapper">
                        ...
                        @if (isset($comaker['co_Emp_Status']))
                            @if ($comaker['co_Emp_Status'] == '1' || $comaker['co_Emp_Status'] == '')
                                ...
                                <input wire:model.lazy="comaker.co_JobDescription" type="text"
                                    data-cb-current-job>
                            @endif
                        @endif
                        ...
                        @if (isset($comaker['co_Emp_Status']))
                            @if ($comaker['co_Emp_Status'] == '0')
                                ...
                                <input wire:model.lazy="comaker.co_JobDescription" type="text"
                                    data-cb-previous-job>
                            @endif
                        @endif
                        @error('comaker.co_JobDescription')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-wrapper">
                        <span>Company Name</span>
                        <input wire:model.lazy="comaker.co_CompanyName" type="text" id="compName"
                            name="compName">
                        @error('comaker.co_CompanyName')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="rowspan">
                    ...
                    <div class="input-wrapper">
                        <span>Company Address</span>
                        <input wire:model.lazy="comaker.co_CompanyID" type="text" id="compAddr"
                            name="compAddr">
                        @error('comaker.co_CompanyID')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-wrapper">
                        <span>Monthly Salary</span>
                        <input wire:model.lazy="comaker.co_MonthlySalary" type="number" id="monthSal"
                            name="monthSal">
                        @error('comaker.co_MonthlySalary')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-wrapper">
                        <span>Other Source Of Income</span>
                        <input wire:model.lazy="comaker.co_OtherSOC" type="text" id="othSorOfInc"
                            name="othSorOfInc">
                        @error('comaker.co_OtherSOC')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-wrapper">
                        ...
                        <div class="box-wrap">
                            ...
                            <!-- * Rented -->
                            <div class="radio-btn-wrapper">
                                <input wire:model.lazy="comaker.co_BO_Status" autocomplete="off" type="radio"
                                    name="co_BO_Status" value="1">
                                <span>Yes</span>
                            </div>
                            ...
                            <div class="radio-btn-wrapper">
                                <input wire:model.lazy="comaker.co_BO_Status" autocomplete="off" type="radio"
                                    name="co_BO_Status" value="0">
                                <span>No</span>
                            </div>

                        </div>
                        @error('comaker.co_BO_Status')
                            <span class="text-required">{{ $message }}</span>
                        @enderror
                    </div>
